...
public class Gerente_Gerente extends JDialog implements ActionListener, KeyListener, MouseListener {
	...
	public static void main(String[] args) {
		try {
			Gerente_Gerente dialog = new Gerente_Gerente();
	 ...
	 * Create the dialog.
	 */
		public Gerente_Gerente() {
		setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
		setTitle("Gerente");
		setBounds(100, 100, 878, 723);
		getContentPane().setLayout(new BorderLayout());
		contentPanel.setBorder(new EmptyBorder(5, 5, 5, 5));
		getContentPane().add(contentPanel, BorderLayout.CENTER);
		contentPanel.setLayout(null);
		{
			lblDatosDeV = new JLabel("Gerente");
		...
		}
		{
			...
			lblGenero.setBounds(30, 200, 69, 25);
		...
		}
		{
			...
			cb_genero.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		}
		{
			...
			txt_celular.setBounds(464, 86, 106, 25);
			contentPanel.add(txt_celular);
			txt_celular.setColumns(10);
		}
		{
			lbl_CelularNum = new JLabel("SOLO N\u00DAMEROS");
			lbl_CelularNum.setForeground(Color.RED);
			lbl_CelularNum.setFont(new Font("Tahoma", Font.BOLD, 11));
			lbl_CelularNum.setBounds(580, 91, 107, 14);
			lbl_CelularNum.setVisible(false);
			contentPanel.add(lbl_CelularNum);
		}
		{
			txt_edad = new JTextField();
			txt_edad.addKeyListener(this);
			txt_edad.setBounds(464, 122, 106, 25);
			contentPanel.add(txt_edad);
			txt_edad.setColumns(10);
		}
		{
			txt_user = new JTextField();
			txt_user.setBounds(464, 161, 139, 25);
		...
		}
		{
			...
			txt_sueldo.setBounds(464, 245, 106, 25);
		...
		}
		{
			...
			btnNewButton.setIcon(new ImageIcon(Gerente_Gerente.class.getResource("/Imagenes/plus-circle-regular-24.png")));
			btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 14));
			btnNewButton.addActionListener(this);
			btnNewButton.setBounds(674, 63, 133, 36);
			contentPanel.add(btnNewButton);
		}
		{
			btnModificar = new JButton("   Modificar");
			btnModificar.setIcon(new ImageIcon(Gerente_Gerente.class.getResource("/Imagenes/edit-solid-24.png")));
			btnModificar.setHorizontalAlignment(SwingConstants.LEFT);
			btnModificar.setFont(new Font("Tahoma", Font.PLAIN, 14));
			btnModificar.addActionListener(this);
			btnModificar.setBounds(674, 115, 133, 36);
			contentPanel.add(btnModificar);
		}
		{
			btnEliminar = new JButton("   Eliminar");
			btnEliminar.setIcon(new ImageIcon(Gerente_Gerente.class.getResource("/Imagenes/trash-alt-solid-24.png")));
			btnEliminar.setHorizontalAlignment(SwingConstants.LEFT);
			btnEliminar.setFont(new Font("Tahoma", Font.PLAIN, 14));
			btnEliminar.addActionListener(this);
			btnEliminar.setBounds(674, 168, 133, 36);
			contentPanel.add(btnEliminar);
		}
		{
			scrollPane = new JScrollPane();
			scrollPane.setBounds(30, 358, 804, 290);
			contentPanel.add(scrollPane);
			{
				tableModel = new DefaultTableModel(
			            new Object[][] {},
			            new String[] {
			                "Código Gerente", "Nombres", "Apellidos", "DNI",
				...
				}
				{
					...
					button.setIcon(new ImageIcon(Gerente_Gerente.class.getResource("/Imagenes/aleatorio.png")));
				...
				}
				{
					...
					txt_pass.setBounds(464, 204, 139, 25);
				...
				}
				{
					...
					btnLimpiar.setIcon(new ImageIcon(Gerente_Gerente.class.getResource("/Imagenes/mop.png")));
					btnLimpiar.setHorizontalAlignment(SwingConstants.LEFT);
					btnLimpiar.setFont(new Font("Tahoma", Font.PLAIN, 14));
					btnLimpiar.setBounds(674, 215, 133, 36);
				...
				}
				{
					...
					lblEdadNum.setBounds(580, 123, 104, 14);
					contentPanel.add(lblEdadNum);
					lblEdadNum.setVisible(false);
				}
				{
					lblDNI = new JLabel("SOLO N\u00DAMEROS");
					lblDNI.setForeground(Color.RED);
					lblDNI.setFont(new Font("Tahoma", Font.BOLD, 11));
					lblDNI.setBounds(254, 163, 104, 14);
				...
				}
				{
					...
					lblSueldoNum.setBounds(580, 250, 104, 14);
				...
				}
				{
					...
					setJMenuBar(menuBar);
					{
						...
						menuBar.add(mnSalir);
						{
							...
							mntmSalir.setIcon(new ImageIcon(Gerente_Gerente.class.getResource("/Imagenes/cerrar-simbolo-de-boton-circular.png")));
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent arg0) {
		if(tbd.verSoloGerente(obtenerDatos().getCodigoTrabajador()) == null){
			tbd.insertarBDGerente(obtenerDatos());
	...
	Gerente obtenerDatos(){
		...
		Gerente g = new Gerente(codigoTrabajador, nombreTrabajador, apellidoTrabajador, 
	...
	public void Listar(String nombre, String apellido, String dni){
		ArrayList<Gerente> alg = new ArrayList<>();
		
		tableModel.setRowCount(0);

		if(nombre.length()==0 && apellido.length()==0&&dni.length()==0){
			alg = tbd.verTodosGerentes();
		}else{
			alg = tbd.consultarGerente(nombre, apellido, dni);
		}	
	...
	protected void do_btnModificar_actionPerformed(ActionEvent arg0) {
		try{
			...
			Double sueldoTrabajador = Double.parseDouble(txt_sueldo.getText());
			String area = txt_area.getText();
			Gerente v = new Gerente(txt_Cod.getText(), txt_nombre.getText(),txt_apellido.getText(),
			...
			tbd.modificarGerente(v, txt_Cod.getText());		
			txtFnombre.setText("");
			txtFapellido.setText("");
			txtFdni.setText("");
			Listar(txtFnombre.getText(),txtFapellido.getText(), txtFdni.getText());	
			Limpiar();
			JOptionPane.showMessageDialog(this, "El gerente ha sido modificado exitosamente");
		}catch(Exception e){
			JOptionPane.showMessageDialog(this, "No se pudo modificar el gerente");
		}
	...
	protected void do_JTable_mouseClicked(MouseEvent arg0) {
		...
		Gerente v = tbd.verSoloGerente(cod);
	...
	protected void do_button_actionPerformed(ActionEvent arg0) {
		String cod = generaCodTrabajador("GN");
	...
	protected void do_txt_celular_keyTyped(KeyEvent arg0) {
		validarNumero(arg0, lbl_CelularNum, txt_celular,9);
	}
	...
	protected void do_txt_dni_keyTyped(KeyEvent arg0) {
		validarNumero(arg0, lblDNI, txt_dni,8);
	}
}
